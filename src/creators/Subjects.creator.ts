...
export default class SubjectsCreator {
    ...
    async createSubjectObjects (): Promise<Subject[]> {
        ...
        if (!subjects || !subjects.success) throw subjects.errors || 'we cannot get the subjects correctly'
    ...
    async createMaterialObjects (): Promise<Material[]> {
        ...
        if (!materials || !materials.success) throw materials.errors || 'we cannot get the subjects correctly'
